...
class HebraConsumidor4 extends Thread{
private int id;
private int n, k;
private MonitorMultibufferLC monitorAlm;
private Random r;

public HebraConsumidor4(int i, int n, MonitorMultibufferLC a, Random ran, int k) {
	this.id = i;
	this.n =n;
	this.monitorAlm =a;
	this.k =k;
...
class HebraProductor4 extends Thread{
private int id;
private int n, k;
private MonitorMultibufferLC monitorAlm;
private Random r;
...
public HebraProductor4(int i,int n, MonitorMultibufferLC a, Random ran, int k) {
	this.id = i;
	this.n = n;
	this.monitorAlm =a;
	this.k=k;
...
public class MainP22 {
	...
	public static void main(String[] args) {
        ...
        MonitorMultibufferLC monitorAlm = new MonitorMultibufferLC(k);

        ArrayList<Thread> array = new ArrayList<Thread>(); 
        
        for (int i = 1; i <= m; i++) {
            Thread h1 = new HebraConsumidor4(i,n, monitorAlm, ran, k);
            Thread h2 = new HebraProductor4(i,n, monitorAlm, ran, k);
            array.add(h1);
            array.add(h2);
            h1.start();
            h2.start();
